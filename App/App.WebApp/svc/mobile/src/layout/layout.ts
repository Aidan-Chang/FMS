...
export class MobileLayout {
  ...
  items: MenuItem[] = [
    { label: 'Home', icon: 'pi pi-home', routerLink: '/m/home' },
    { label: 'TQM', icon: 'pi pi-map-marker', routerLink: '/m/home' },
    { label: 'Capture', icon: 'pi pi-camera', routerLink: '/m/tqm/track/capture' },
    { label: 'Repair', icon: 'pi pi-wrench', },
